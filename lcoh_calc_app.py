...
def calculate_lcoh():
    try:
        capex = float(request.args.get('capex', 1000))
        opex = float(request.args.get('opex', 3))
        elec_price = float(request.args.get('elec_price', 50))
        elec_consumption = float(request.args.get('elec_consumption', 50))
